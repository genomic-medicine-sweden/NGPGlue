...
## perl fohm_upload.pl /gms-storage-gu/gothenburg/covid-temp/output-ssh /gms-storage-gu/gothenburg/covid-temp/output-ssh/UploadStage/ ./FohmAndGisaidMinimumExamplelim3NoBom.csv  /gms-storage-gu/gothenburg/covid-temp/test-artic

## perl fohm_upload.pl /gms-storage-gu/gothenburg/covid-temp/output-ssh /gms-storage-gu/gothenburg/covid-temp/output-ssh/UploadStage/ covidMetadataTemplateNoBOMNGP.json /gms-storage-gu/gothenburg/covid-temp/test-artic TEST-SSH
...
my $fastqdir = $ARGV[3];
my $Analysis_name = $ARGV[4]; ## NB same as for artic!!!  ExperimentData TEST-SSH
...
print "Check this command and run it to upload to FOHM:\n\n";
